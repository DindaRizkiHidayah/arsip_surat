...
$arsip = mysqli_fetch_array($query);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
                  ...
                  <div class="card-body">
                    ...
                    <form action="add_data_surat.php" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="no_surat" placeholder="Nomor surat" value="<?php echo $arsip['no_arsip']?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleSelectGender">Kategori</label>
                        <select class="form-control" name="kategori" value="<?php echo $arsip['kategori']?>">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="judul" placeholder="Judul" value="<?php echo $arsip['judul']?>">
                      </div>
                      <div class="form-group">
                        <label>File Surat (PDF)</label>
                        <td class="form-control" style="height: 50px"><input type="file" name="data_surat" class="form-control" value="<?php echo $arsip['data_surat']?>"></td>
                      </div><br>
                      <div class="form-group">
